...
public:
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, const VulkanSwapChainManager& swapChainManager, VulkanGraphicsPipeline graphicsPipeline, uint32_t imageIndex, const VulkanModel& model)
    {
    ...
    void drawFrame(GLFWwindow* window, const VulkanContext& context, VulkanSwapChainManager& swapChainManager, const VulkanGraphicsPipeline& graphicsPipeline, const VulkanCommandBufferManager& commandBufferManager, const VulkanModel& model)
    {
        ...
        // Automatically recreate swapchain if needed
        if (result == VK_ERROR_OUT_OF_DATE_KHR)
        {
            swapChainManager.recreateSwapChain(window, context);
            return;
        }
