...
void VulkanGraphicsPipeline::init(const VulkanContext& context, const VulkanSwapChainManager& swapChainManager)
{
    createRenderPass(context, swapChainManager);
    createDescriptorSetLayout(context);
    createGraphicsPipeline(context, swapChainManager);
}

void VulkanGraphicsPipeline::createDescriptorSetLayout(const VulkanContext& context)
{
...
void VulkanGraphicsPipeline::createDescriptorSets(const VulkanContext& context, const std::vector<VkBuffer>& uniformBuffers, const VulkanTexture& texture)
{
...
void VulkanGraphicsPipeline::createDescriptorPool(const VulkanContext& context)
{
...
void VulkanGraphicsPipeline::createUniformBuffers(const VulkanContext& context)
{
...
void VulkanGraphicsPipeline::createRenderPass(const VulkanContext& context, const VulkanSwapChainManager& swapChainManager)
{
...
void VulkanGraphicsPipeline::createGraphicsPipeline(const VulkanContext& context, const VulkanSwapChainManager& swapChain)
{
